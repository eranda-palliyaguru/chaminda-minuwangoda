            ...
            <div class="col-md-6">
              <div class="form-group">
			   ...
			   <div class="form-group">
                ...
                <input type="text" class="form-control" name="phone_no" data-inputmask='"mask": "(999)-9999999"' data-mask required>
                  </div>
                  </div>
          ...
          <div class="row">
            <div class="col-md-6">
			  ...
			  <div class="form-group">
                ...
                <input type="text" name="color" class="form-control pull-right"  required>
                  </div>
                  </div> 
              </div>
              </div>
