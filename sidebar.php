  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
		...
		<?php 
		  $ch=$_SESSION['SESS_FIRST_NAME'];
		  if($ch=="Mr.Chaminda"){ ?>	  
		  
		  <li>
          <a  href="stock_up.php">
            <i class="fa fa-cubes"></i> <span>Stock Up</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
	...
	<?php } ?>	  
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="month_end.php"><i class="fa fa-circle-o text-yellow"></i> Quotations Report</a></li>
			<li><a href="transfer.php"><i class="fa fa-circle-o text-yellow"></i> Product Transfer Report</a></li>
