 ...
 <script type="text/javascript">
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      ...
      <form action="stock_up_rp.php" method="get">   
	<center>
...
To:<input type="text" style="width:223px; padding:4px;" name="d2" id="datepickerd"  value="" autocomplete="off"/>
 ...
 <i class="icon icon-search icon-large"></i> Search
   ...
   <section class="content">
     ...
     <div class="box">
            <div class="box-header">
              <h3 class="box-title">Stock up Report</h3>
            </div>
            <!-- /.box-header -->
   ...
   $d1=$_GET['d1'];
				$d2=$_GET['d2'];
			 $tot=0;
   $result = $db->prepare("SELECT * FROM stock_up WHERE  date BETWEEN '$d1' AND '$d2'  ");
